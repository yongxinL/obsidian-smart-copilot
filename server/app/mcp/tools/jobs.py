"""jobs stubs — D-05 not_implemented payload, registered + discoverable.
...
_AVAILABLE_IN_PHASE = "7"

_TOOLS: tuple[tuple[str, str], ...] = (
    (
        "jobs.submit",
        "Submit a durable DAG job for async execution. "
        "Available in Phase 7.",
    ),
    (
        "jobs.status",
        "Check the status of a submitted job by job_id. "
        "Available in Phase 7.",
    ),
    (
        "jobs.cancel",
        "Cancel a running or pending job by job_id. "
        "Available in Phase 7.",
    ),
)
