"""brain.graph stubs — D-05 not_implemented payload, registered + discoverable.
...
_AVAILABLE_IN_PHASE = "2b"

_TOOLS: tuple[tuple[str, str], ...] = (
    (
        "brain.graph.traverse",
        "Traverse the knowledge graph from a starting node with depth/breadth "
        "limits and edge type filters. Available in Phase 2b.",
    ),
)
